      ...
      <div
        className={
          isSideBarOpen
            ...
            : "bg-[#635fc7] dark:bg-[#2b2c37] dark:hover:bg-[#635fc7] top-auto bottom-10 justify-center items-center hover:opacity-80 cursor-pointer p-0 transition duration-300 transfrom fixed w-[56px] h-[48px] rounded-r-full"
        }
      >
        <div>
          {/* Rewrite Modal */}
